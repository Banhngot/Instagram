...
import com.neatroots.instagram.Adapers.SearchAdapter
...
import com.neatroots.instagram.databinding.FragmentSearchBinding
...
class SearchFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.searchButton.setOnClickListener {
            var text=binding.searchView2.text.toString()
